...
st.set_page_config(
    page_title="220711660 - Unsupervised Learning",
    page_icon="📊",
    layout="wide",
...
if uploaded_file is not None:
    ...
    st.markdown("<h1 style='text-align: center;'>Unsupervised Learning - 220711660</h1>", unsafe_allow_html=True)
    st.dataframe(input_data)

    model_directory = r'D:\PMDPM\Unsupervised Learning (Praktek)\Tugas4_A_11660'
    model_path = {
